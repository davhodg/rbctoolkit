...
static Tk_ConfigSpec textConfigSpecs[] = {
    ...
    {TK_CONFIG_COLOR, "-background", "background", "MarkerBackground", (char *)NULL, offsetof(TextMarker, fillColor), TK_CONFIG_NULL_OK},
    {TK_CONFIG_SYNONYM, "-bg", "background", "Background", (char *)NULL, 0, 0},
    {TK_CONFIG_CUSTOM, "-bindtags", "bindTags", "BindTags", DEF_MARKER_TEXT_TAGS, offsetof(Marker, tags), TK_CONFIG_NULL_OK, &rbcListOption},
    {TK_CONFIG_CUSTOM, "-coords", "coords", "Coords", DEF_MARKER_COORDS, offsetof(Marker, worldPts), TK_CONFIG_NULL_OK, &coordsOption},
    {TK_CONFIG_STRING, "-element", "element", "Element", DEF_MARKER_ELEMENT, offsetof(Marker, elemName), TK_CONFIG_NULL_OK},
    ...
    {TK_CONFIG_COLOR, "-foreground", "foreground", "Foreground", DEF_MARKER_FOREGROUND, offsetof(TextMarker, style.color), TK_CONFIG_COLOR_ONLY},
    {TK_CONFIG_COLOR, "-foreground", "foreground", "Foreground", DEF_MARKER_FG_MONO, offsetof(TextMarker, style.color), TK_CONFIG_MONO_ONLY},
    {TK_CONFIG_JUSTIFY, "-justify", "justify", "Justify", DEF_MARKER_JUSTIFY, offsetof(TextMarker, style.justify), TK_CONFIG_DONT_SET_DEFAULT},
    ...
    {TK_CONFIG_CUSTOM, "-padx", "padX", "PadX", DEF_MARKER_PAD, offsetof(TextMarker, style.padX), TK_CONFIG_DONT_SET_DEFAULT, &rbcPadOption},
    {TK_CONFIG_CUSTOM, "-pady", "padY", "PadY", DEF_MARKER_PAD, offsetof(TextMarker, style.padY), TK_CONFIG_DONT_SET_DEFAULT, &rbcPadOption},
    {TK_CONFIG_DOUBLE, "-rotate", "rotate", "Rotate", DEF_MARKER_ROTATE, offsetof(TextMarker, style.theta), TK_CONFIG_DONT_SET_DEFAULT},
    {TK_CONFIG_CUSTOM, "-shadow", "shadow", "Shadow", DEF_MARKER_SHADOW_COLOR, offsetof(TextMarker, style.shadow), TK_CONFIG_COLOR_ONLY, &rbcShadowOption},
    {TK_CONFIG_CUSTOM, "-shadow", "shadow", "Shadow", DEF_MARKER_SHADOW_MONO, offsetof(TextMarker, style.shadow), TK_CONFIG_MONO_ONLY, &rbcShadowOption},
    {TK_CONFIG_CUSTOM, "-state", "state", "State", DEF_MARKER_STATE, offsetof(Marker, state), TK_CONFIG_DONT_SET_DEFAULT, &rbcStateOption},
    {TK_CONFIG_STRING, "-text", "text", "Text", DEF_MARKER_TEXT, offsetof(TextMarker, string), TK_CONFIG_NULL_OK},
    {TK_CONFIG_BOOLEAN, "-under", "under", "Under", DEF_MARKER_UNDER, offsetof(Marker, drawUnder), TK_CONFIG_DONT_SET_DEFAULT},
    {TK_CONFIG_PIXELS, "-xoffset", "xOffset", "XOffset", DEF_MARKER_X_OFFSET, offsetof(Marker, xOffset), TK_CONFIG_DONT_SET_DEFAULT},
    {TK_CONFIG_PIXELS, "-yoffset", "yOffset", "YOffset", DEF_MARKER_Y_OFFSET, offsetof(Marker, yOffset), TK_CONFIG_DONT_SET_DEFAULT},
...
static Tk_ConfigSpec windowConfigSpecs[] = {
    ...
    {TK_CONFIG_CUSTOM, "-bindtags", "bindTags", "BindTags", DEF_MARKER_WINDOW_TAGS, offsetof(Marker, tags), TK_CONFIG_NULL_OK, &rbcListOption},
    {TK_CONFIG_CUSTOM, "-coords", "coords", "Coords", DEF_MARKER_COORDS, offsetof(WindowMarker, worldPts), TK_CONFIG_NULL_OK, &coordsOption},
    {TK_CONFIG_STRING, "-element", "element", "Element", DEF_MARKER_ELEMENT, offsetof(Marker, elemName), TK_CONFIG_NULL_OK},
    {TK_CONFIG_CUSTOM, "-height", "height", "Height", DEF_MARKER_HEIGHT, offsetof(WindowMarker, reqHeight), TK_CONFIG_DONT_SET_DEFAULT, &rbcPositiveDistanceOption},
    {TK_CONFIG_BOOLEAN, "-hide", "hide", "Hide", DEF_MARKER_HIDE, offsetof(Marker, hidden), TK_CONFIG_DONT_SET_DEFAULT},
    {TK_CONFIG_CUSTOM, "-mapx", "mapX", "MapX", DEF_MARKER_MAP_X, offsetof(Marker, axes.x), 0, &rbcXAxisOption},
    {TK_CONFIG_CUSTOM, "-mapy", "mapY", "MapY", DEF_MARKER_MAP_Y, offsetof(Marker, axes.y), 0, &rbcYAxisOption},
    {TK_CONFIG_STRING, "-name", (char *)NULL, (char *)NULL, DEF_MARKER_NAME, offsetof(Marker, name), TK_CONFIG_NULL_OK},
    {TK_CONFIG_CUSTOM, "-state", "state", "State", DEF_MARKER_STATE, offsetof(Marker, state), TK_CONFIG_DONT_SET_DEFAULT, &rbcStateOption},
    {TK_CONFIG_BOOLEAN, "-under", "under", "Under", DEF_MARKER_UNDER, offsetof(Marker, drawUnder), TK_CONFIG_DONT_SET_DEFAULT},
    {TK_CONFIG_CUSTOM, "-width", "width", "Width", DEF_MARKER_WIDTH, offsetof(WindowMarker, reqWidth), TK_CONFIG_DONT_SET_DEFAULT, &rbcPositiveDistanceOption},
    {TK_CONFIG_STRING, "-window", "window", "Window", DEF_MARKER_WINDOW, offsetof(WindowMarker, pathName), TK_CONFIG_NULL_OK},
    {TK_CONFIG_PIXELS, "-xoffset", "xOffset", "XOffset", DEF_MARKER_X_OFFSET, offsetof(Marker, xOffset), TK_CONFIG_DONT_SET_DEFAULT},
    {TK_CONFIG_PIXELS, "-yoffset", "yOffset", "YOffset", DEF_MARKER_Y_OFFSET, offsetof(Marker, yOffset), TK_CONFIG_DONT_SET_DEFAULT},
    {TK_CONFIG_END, NULL, NULL, NULL, NULL, 0, 0}
};
...
static Tk_ConfigSpec bitmapConfigSpecs[] = {
    {TK_CONFIG_ANCHOR, "-anchor", "anchor", "Anchor",
        DEF_MARKER_ANCHOR, offsetof(BitmapMarker, anchor), 0},
    {TK_CONFIG_COLOR, "-background", "background", "Background",
     DEF_MARKER_BACKGROUND, offsetof(BitmapMarker, fillColor),
     TK_CONFIG_COLOR_ONLY | TK_CONFIG_NULL_OK},
    {TK_CONFIG_COLOR, "-background", "background", "Background",
     DEF_MARKER_BG_MONO, offsetof(BitmapMarker, fillColor),
     TK_CONFIG_MONO_ONLY | TK_CONFIG_NULL_OK},
    {TK_CONFIG_SYNONYM, "-bg", "background", (char *)NULL,
     (char *)NULL, 0, 0},
    {TK_CONFIG_CUSTOM, "-bindtags", "bindTags", "BindTags",
     DEF_MARKER_BITMAP_TAGS, offsetof(Marker, tags),
     TK_CONFIG_NULL_OK, &rbcListOption},
    {TK_CONFIG_BITMAP, "-bitmap", "bitmap", "Bitmap",
     DEF_MARKER_BITMAP, offsetof(BitmapMarker, srcBitmap),
     TK_CONFIG_NULL_OK},
    {TK_CONFIG_CUSTOM, "-coords", "coords", "Coords",
     DEF_MARKER_COORDS, offsetof(Marker, worldPts),
     TK_CONFIG_NULL_OK, &coordsOption},
    {TK_CONFIG_STRING, "-element", "element", "Element",
     DEF_MARKER_ELEMENT, offsetof(Marker, elemName), TK_CONFIG_NULL_OK},
    {TK_CONFIG_SYNONYM, "-fg", "foreground", (char *)NULL,
     (char *)NULL, 0, 0},
    {TK_CONFIG_SYNONYM, "-fill", "background", (char *)NULL,
     (char *)NULL, 0, 0},
    {TK_CONFIG_COLOR, "-foreground", "foreground", "Foreground",
     DEF_MARKER_FOREGROUND, offsetof(BitmapMarker, outlineColor),
     TK_CONFIG_COLOR_ONLY | TK_CONFIG_NULL_OK},
    {TK_CONFIG_COLOR, "-foreground", "foreground", "Foreground",
     DEF_MARKER_FG_MONO, offsetof(BitmapMarker, outlineColor),
     TK_CONFIG_MONO_ONLY | TK_CONFIG_NULL_OK},
    {TK_CONFIG_BOOLEAN, "-hide", "hide", "Hide",
     DEF_MARKER_HIDE, offsetof(Marker, hidden),
     TK_CONFIG_DONT_SET_DEFAULT},
    {TK_CONFIG_CUSTOM, "-mapx", "mapX", "MapX",
     DEF_MARKER_MAP_X, offsetof(Marker, axes.x), 0, &rbcXAxisOption},
    {TK_CONFIG_CUSTOM, "-mapy", "mapY", "MapY",
     DEF_MARKER_MAP_Y, offsetof(Marker, axes.y), 0, &rbcYAxisOption},
    {TK_CONFIG_STRING, "-name", (char *)NULL, (char *)NULL,
     DEF_MARKER_NAME, offsetof(Marker, name), TK_CONFIG_NULL_OK},
    {TK_CONFIG_SYNONYM, "-outline", "foreground", (char *)NULL,
     (char *)NULL, 0, 0},
    {TK_CONFIG_DOUBLE, "-rotate", "rotate", "Rotate",
     DEF_MARKER_ROTATE, offsetof(BitmapMarker, rotate),
     TK_CONFIG_DONT_SET_DEFAULT},
    {TK_CONFIG_CUSTOM, "-state", "state", "State",
     DEF_MARKER_STATE, offsetof(Marker, state),
     TK_CONFIG_DONT_SET_DEFAULT, &rbcStateOption},
    {TK_CONFIG_BOOLEAN, "-under", "under", "Under",
     DEF_MARKER_UNDER, offsetof(Marker, drawUnder),
     TK_CONFIG_DONT_SET_DEFAULT},
    {TK_CONFIG_PIXELS, "-xoffset", "xOffset", "XOffset",
     DEF_MARKER_X_OFFSET, offsetof(Marker, xOffset),
     TK_CONFIG_DONT_SET_DEFAULT},
    {TK_CONFIG_PIXELS, "-yoffset", "yOffset", "YOffset",
     DEF_MARKER_Y_OFFSET, offsetof(Marker, yOffset),
     TK_CONFIG_DONT_SET_DEFAULT},
    {TK_CONFIG_END, NULL, NULL, NULL, NULL, 0, 0}
};
...
static Tk_ConfigSpec imageConfigSpecs[] = {
    {TK_CONFIG_ANCHOR, "-anchor", "anchor", "Anchor",
        DEF_MARKER_ANCHOR, offsetof(ImageMarker, anchor), 0},
    {TK_CONFIG_CUSTOM, "-bindtags", "bindTags", "BindTags",
     DEF_MARKER_IMAGE_TAGS, offsetof(Marker, tags),
     TK_CONFIG_NULL_OK, &rbcListOption},
    {TK_CONFIG_CUSTOM, "-coords", "coords", "Coords",
     DEF_MARKER_COORDS, offsetof(Marker, worldPts),
     TK_CONFIG_NULL_OK, &coordsOption},
    ...
    {TK_CONFIG_STRING, "-image", "image", "Image",
     (char *)NULL, offsetof(ImageMarker, imageName), TK_CONFIG_NULL_OK},
    {TK_CONFIG_CUSTOM, "-mapx", "mapX", "MapX",
     DEF_MARKER_MAP_X, offsetof(Marker, axes.x), 0, &rbcXAxisOption},
    {TK_CONFIG_CUSTOM, "-mapy", "mapY", "MapY",
     DEF_MARKER_MAP_Y, offsetof(Marker, axes.y), 0, &rbcYAxisOption},
...
static Tk_ConfigSpec lineConfigSpecs[] = {
    {TK_CONFIG_CUSTOM, "-bindtags", "bindTags", "BindTags",
        DEF_MARKER_LINE_TAGS, offsetof(Marker, tags),
        TK_CONFIG_NULL_OK, &rbcListOption},
    {TK_CONFIG_CAP_STYLE, "-cap", "cap", "Cap",
     DEF_MARKER_CAP_STYLE, offsetof(LineMarker, capStyle),
     TK_CONFIG_DONT_SET_DEFAULT},
    {TK_CONFIG_CUSTOM, "-coords", "coords", "Coords",
     DEF_MARKER_COORDS, offsetof(Marker, worldPts),
     TK_CONFIG_NULL_OK, &coordsOption},
    {TK_CONFIG_CUSTOM, "-dashes", "dashes", "Dashes",
     DEF_MARKER_DASHES, offsetof(LineMarker, dashes),
     TK_CONFIG_NULL_OK, &rbcDashesOption},
    {TK_CONFIG_CUSTOM, "-dashoffset", "dashOffset", "DashOffset",
     DEF_MARKER_DASH_OFFSET, offsetof(LineMarker, dashes.offset),
     TK_CONFIG_DONT_SET_DEFAULT, &rbcDistanceOption},
    {TK_CONFIG_STRING, "-element", "element", "Element",
     DEF_MARKER_ELEMENT, offsetof(Marker, elemName), TK_CONFIG_NULL_OK},
    {TK_CONFIG_COLOR, "-fill", "fill", "Fill",
     (char *)NULL, offsetof(LineMarker, fillColor), TK_CONFIG_NULL_OK},
    {TK_CONFIG_JOIN_STYLE, "-join", "join", "Join",
     DEF_MARKER_JOIN_STYLE, offsetof(LineMarker, joinStyle),
     TK_CONFIG_DONT_SET_DEFAULT},
    {TK_CONFIG_CUSTOM, "-linewidth", "lineWidth", "LineWidth",
     DEF_MARKER_LINE_WIDTH, offsetof(LineMarker, lineWidth),
     TK_CONFIG_DONT_SET_DEFAULT, &rbcDistanceOption},
    {TK_CONFIG_BOOLEAN, "-hide", "hide", "Hide",
     DEF_MARKER_HIDE, offsetof(Marker, hidden),
     TK_CONFIG_DONT_SET_DEFAULT},
    ...
    {TK_CONFIG_COLOR, "-outline", "outline", "Outline",
     DEF_MARKER_OUTLINE_COLOR, offsetof(LineMarker, outlineColor),
     TK_CONFIG_COLOR_ONLY | TK_CONFIG_NULL_OK},
    {TK_CONFIG_COLOR, "-outline", "outline", "Outline",
     DEF_MARKER_OUTLINE_MONO, offsetof(LineMarker, outlineColor),
     TK_CONFIG_MONO_ONLY | TK_CONFIG_NULL_OK},
    {TK_CONFIG_CUSTOM, "-state", "state", "State",
     DEF_MARKER_STATE, offsetof(Marker, state),
     TK_CONFIG_DONT_SET_DEFAULT, &rbcStateOption},
    ...
    {TK_CONFIG_BOOLEAN, "-xor", "xor", "Xor",
     DEF_MARKER_XOR, offsetof(LineMarker, xor), TK_CONFIG_DONT_SET_DEFAULT},
    {TK_CONFIG_PIXELS, "-yoffset", "yOffset", "YOffset",
     DEF_MARKER_Y_OFFSET, offsetof(Marker, yOffset),
     TK_CONFIG_DONT_SET_DEFAULT},
    {TK_CONFIG_END, NULL, NULL, NULL, NULL, 0, 0}
...
static Tk_ConfigSpec polygonConfigSpecs[] = {
    {TK_CONFIG_CUSTOM, "-bindtags", "bindTags", "BindTags",
        DEF_MARKER_POLYGON_TAGS, offsetof(Marker, tags),
        TK_CONFIG_NULL_OK, &rbcListOption},
    {TK_CONFIG_CAP_STYLE, "-cap", "cap", "Cap",
     DEF_MARKER_CAP_STYLE, offsetof(PolygonMarker, capStyle),
     TK_CONFIG_DONT_SET_DEFAULT},
    {TK_CONFIG_CUSTOM, "-coords", "coords", "Coords",
     DEF_MARKER_COORDS, offsetof(Marker, worldPts),
     TK_CONFIG_NULL_OK, &coordsOption},
    {TK_CONFIG_CUSTOM, "-dashes", "dashes", "Dashes",
     DEF_MARKER_DASHES, offsetof(PolygonMarker, dashes),
     TK_CONFIG_NULL_OK, &rbcDashesOption},
    {TK_CONFIG_STRING, "-element", "element", "Element",
     DEF_MARKER_ELEMENT, offsetof(Marker, elemName), TK_CONFIG_NULL_OK},
    {TK_CONFIG_CUSTOM, "-fill", "fill", "Fill",
     DEF_MARKER_FILL_COLOR, offsetof(PolygonMarker, fill),
     TK_CONFIG_COLOR_ONLY | TK_CONFIG_NULL_OK, &rbcColorPairOption},
    {TK_CONFIG_CUSTOM, "-fill", "fill", "Fill",
     DEF_MARKER_FILL_MONO, offsetof(PolygonMarker, fill),
     TK_CONFIG_MONO_ONLY | TK_CONFIG_NULL_OK, &rbcColorPairOption},
    {TK_CONFIG_JOIN_STYLE, "-join", "join", "Join",
     DEF_MARKER_JOIN_STYLE, offsetof(PolygonMarker, joinStyle),
     TK_CONFIG_DONT_SET_DEFAULT},
    {TK_CONFIG_CUSTOM, "-linewidth", "lineWidth", "LineWidth",
     DEF_MARKER_LINE_WIDTH, offsetof(PolygonMarker, lineWidth),
     TK_CONFIG_DONT_SET_DEFAULT, &rbcDistanceOption},
    {TK_CONFIG_BOOLEAN, "-hide", "hide", "Hide",
     DEF_MARKER_HIDE, offsetof(Marker, hidden),
     TK_CONFIG_DONT_SET_DEFAULT},
    ...
    {TK_CONFIG_CUSTOM, "-outline", "outline", "Outline",
     DEF_MARKER_OUTLINE_COLOR, offsetof(PolygonMarker, outline),
     TK_CONFIG_COLOR_ONLY | TK_CONFIG_NULL_OK, &rbcColorPairOption},
    {TK_CONFIG_CUSTOM, "-outline", "outline", "Outline",
     DEF_MARKER_OUTLINE_MONO, offsetof(PolygonMarker, outline),
     TK_CONFIG_MONO_ONLY | TK_CONFIG_NULL_OK, &rbcColorPairOption},
    {TK_CONFIG_CUSTOM, "-state", "state", "State",
     DEF_MARKER_STATE, offsetof(Marker, state),
     TK_CONFIG_DONT_SET_DEFAULT, &rbcStateOption},
    {TK_CONFIG_BITMAP, "-stipple", "stipple", "Stipple",
     DEF_MARKER_STIPPLE, offsetof(PolygonMarker, stipple),
     TK_CONFIG_NULL_OK},
    {TK_CONFIG_BOOLEAN, "-under", "under", "Under",
     DEF_MARKER_UNDER, offsetof(Marker, drawUnder),
     TK_CONFIG_DONT_SET_DEFAULT},
    {TK_CONFIG_PIXELS, "-xoffset", "xOffset", "XOffset",
     ...
     TK_CONFIG_DONT_SET_DEFAULT},
    {TK_CONFIG_BOOLEAN, "-xor", "xor", "Xor",
     DEF_MARKER_XOR, offsetof(PolygonMarker, xor),
     TK_CONFIG_DONT_SET_DEFAULT},
    {TK_CONFIG_PIXELS, "-yoffset", "yOffset", "YOffset",
     DEF_MARKER_Y_OFFSET, offsetof(Marker, yOffset),
     TK_CONFIG_DONT_SET_DEFAULT},
...
static MarkerCreateProc CreateBitmapMarker, CreateLineMarker, CreateImageMarker, CreatePolygonMarker, CreateTextMarker, CreateWindowMarker;
static MarkerDrawProc DrawBitmapMarker, DrawLineMarker, DrawImageMarker, DrawPolygonMarker, DrawTextMarker, DrawWindowMarker;
static MarkerFreeProc FreeBitmapMarker, FreeLineMarker, FreeImageMarker, FreePolygonMarker, FreeTextMarker, FreeWindowMarker;
static MarkerConfigProc ConfigureBitmapMarker, ConfigureLineMarker, ConfigureImageMarker, ConfigurePolygonMarker, ConfigureTextMarker, ConfigureWindowMarker;
static MarkerMapProc MapBitmapMarker, MapLineMarker, MapImageMarker, MapPolygonMarker, MapTextMarker, MapWindowMarker;
static MarkerPostScriptProc BitmapMarkerToPostScript, LineMarkerToPostScript, ImageMarkerToPostScript, PolygonMarkerToPostScript, TextMarkerToPostScript, WindowMarkerToPostScript;
static MarkerPointProc PointInBitmapMarker, PointInLineMarker, PointInImageMarker, PointInPolygonMarker, PointInTextMarker, PointInWindowMarker;
    ...
    Marker *markerPtr;
{
    ...
    if (bmPtr->nWorldPts == 1) {
        anchorPos = Rbc_TranslatePoint(&corner1, destWidth, destHeight,
                                       bmPtr->anchor);
    } else {
        anchorPos = corner1;
    }
    ...
    if ((bmPtr->theta != 0.0) || (destWidth != srcWidth) ||
        ...
        anchorPos.x = left;
        anchorPos.y = top;
        bmPtr->destBitmap = Rbc_ScaleRotateBitmapRegion(graphPtr->tkwin,
    ...
    bmPtr->anchorPos = anchorPos;
    {
         ...
         */
        Rbc_GetBoundingBox(srcWidth, srcHeight, bmPtr->theta, &rotWidth,
                           &rotHeight, polygon);
    ...
    int enclosed;
{
    ...
    if (bmPtr->theta != 0.0) {
        ...
        return Rbc_RegionInPolygon(extsPtr, points, bmPtr->nOutlinePts,
                                   enclosed);
    }
    if (enclosed) {
    ...
    PsToken psToken;
{
    ...
    Rbc_FormatToPostScript(psToken, "    %d %d true [%d 0 0 %d 0 %d] {",
                           bmPtr->destWidth, bmPtr->destHeight, bmPtr->destWidth,
                           -bmPtr->destHeight, bmPtr->destHeight);
    Rbc_BitmapDataToPostScript(psToken, graphPtr->display, bmPtr->destBitmap,
                               bmPtr->destWidth, bmPtr->destHeight);
    ...
    int imageWidth, imageHeight; /* Not used. */
{
    ...
    photo = Rbc_FindPhoto(imPtr->graphPtr->interp, imPtr->imageName);
    if (photo != NULL) {
    ...
    Marker *markerPtr;
{
    ...
    if (Rbc_ConfigModified(graphPtr->interp, markerPtr->classPtr->configSpecs,
        ...
        if (imPtr->imageName != NULL && imPtr->imageName[0] != '\0') {
            ...
            photo = Rbc_FindPhoto(interp, imPtr->imageName);
            if (photo != NULL) {
                if (imPtr->srcImage != NULL) {
                    Rbc_FreeColorImage(imPtr->srcImage);
                }
    ...
    Marker *markerPtr;
{
    ...
    if ((scaledWidth != srcWidth) || (scaledHeight != srcHeight)) {
        ...
        destImage = Rbc_ResizeColorSubimage(imPtr->srcImage, x, y, width,
        ...
        imPtr->pixmap = Rbc_ColorImageToPixmap(graphPtr->interp,
                                               graphPtr->tkwin, destImage, &imPtr->colorTable);
#else
        imPtr->pixmap = None;
        if (imPtr->tmpImage == NULL) {
            imPtr->tmpImage = Rbc_CreateTemporaryImage(graphPtr->interp,
        ...
        photo = Rbc_FindPhoto(graphPtr->interp,
                              Rbc_NameOfImage(imPtr->tmpImage));
    ...
    PsToken psToken;
{
    ...
    imageName = (imPtr->tmpImage == NULL)
                ? Rbc_NameOfImage(imPtr->tkImage) : Rbc_NameOfImage(imPtr->tmpImage);
    photo = Rbc_FindPhoto(markerPtr->graphPtr->interp, imageName);
    if (photo == NULL) {
        return;			/* Image isn't a photo image */
    }
    Rbc_PhotoToPostScript(psToken, photo, imPtr->anchorPos.x,
                          imPtr->anchorPos.y);
}
    ...
    Marker *markerPtr;
{
    ...
    if (Rbc_ConfigModified(graphPtr->interp, tmPtr->classPtr->configSpecs,
        ...
        if (tmPtr->string != NULL) {
            ...
            Rbc_GetBoundingBox(tmPtr->textPtr->width, tmPtr->textPtr->height,
    ...
    Marker *markerPtr;
{
    ...
    anchorPos = Rbc_TranslatePoint(&anchorPos, tmPtr->width, tmPtr->height,
                                   tmPtr->anchor);
    ...
    Drawable drawable; /* Pixmap or window to draw into */
{
    ...
    if (tmPtr->style.color != NULL) {
        Rbc_DrawTextLayout(graphPtr->tkwin, drawable, tmPtr->textPtr,
    ...
    PsToken psToken;
{
    ...
    Rbc_TextToPostScript(psToken, tmPtr->string, &tmPtr->style,
    ...
    Marker *markerPtr;
{
    ...
    wmPtr->anchorPos = Rbc_TranslatePoint(&wmPtr->anchorPos, width, height,
                                          wmPtr->anchor);
    ...
    PsToken psToken;
{
    ...
    if (Tk_IsMapped(wmPtr->tkwin)) {
        Rbc_WindowToPostScript(psToken, wmPtr->tkwin, wmPtr->anchorPos.x,
                               wmPtr->anchorPos.y);
    }
}
    ...
    Point2D *samplePtr;
{
    ...
    return Rbc_PointInSegments(samplePtr, lmPtr->segments, lmPtr->nSegments,
    ...
    Drawable drawable; /* Pixmap or window to draw into */
{
    ...
    if (lmPtr->nSegments > 0) {
        ...
        Rbc_Draw2DSegments(graphPtr->display, drawable, lmPtr->gc,
    ...
    PsToken psToken;
{
    ...
    if (lmPtr->nSegments > 0) {
        Rbc_LineAttributesToPostScript(psToken, lmPtr->outlineColor,
    ...
    Point2D *samplePtr;
{
    ...
    return Rbc_PointInPolygon(samplePtr, pmPtr->screenPts,
                              pmPtr->nWorldPts + 1);
}
    ...
    int enclosed;
{
    ...
    if (pmPtr->nWorldPts >= 3) {
        return Rbc_RegionInPolygon(extsPtr, pmPtr->screenPts, pmPtr->nWorldPts,
                                   enclosed);
    }
    return FALSE;
}
    ...
    Drawable drawable; /* Pixmap or window to draw into */
{
    ...
    if ((pmPtr->nOutlinePts > 0) && (pmPtr->lineWidth > 0) &&
        ...
        Rbc_Draw2DSegments(graphPtr->display, drawable, pmPtr->outlineGC,
    ...
    PsToken psToken;
{
    ...
    if ((pmPtr->lineWidth > 0) && (pmPtr->outline.fgColor != NULL)) {
        ...
        Rbc_LineAttributesToPostScript(psToken, pmPtr->outline.fgColor,
        ...
        Rbc_2DSegmentsToPostScript(psToken, pmPtr->outlinePts,
                                   pmPtr->nOutlinePts);
    }
}
    ...
    int under;
{
    ...
    point.x = (double)x;
    point.y = (double)y;
    for (linkPtr = Rbc_ChainLastLink(graphPtr->markers.displayList);
