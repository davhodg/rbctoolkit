...
static Tk_ConfigSpec lineElemConfigSpecs[] = {
    {TK_CONFIG_CUSTOM, "-activepen", "activePen", "ActivePen", DEF_LINE_ACTIVE_PEN, offsetof(Line, activePenPtr), TK_CONFIG_NULL_OK, &rbcLinePenOption},
    {TK_CONFIG_CUSTOM, "-areapattern", "areaPattern", "AreaPattern",
     DEF_LINE_PATTERN, offsetof(Line, fillStipple),
     TK_CONFIG_NULL_OK, &patternOption},
    {TK_CONFIG_COLOR, "-areaforeground", "areaForeground", "areaForeground",
     DEF_LINE_PATTERN_FG, offsetof(Line, fillFgColor), TK_CONFIG_NULL_OK},
    {TK_CONFIG_COLOR, "-areabackground", "areaBackground", "areaBackground",
     DEF_LINE_PATTERN_BG, offsetof(Line, fillBgColor), TK_CONFIG_NULL_OK},
    {TK_CONFIG_CUSTOM, "-areatile", "areaTile", "AreaTile",
     DEF_LINE_PATTERN_TILE, offsetof(Line, fillTile),
     TK_CONFIG_NULL_OK, &rbcTileOption},
    {TK_CONFIG_CUSTOM, "-bindtags", "bindTags", "BindTags",
     DEF_LINE_TAGS, offsetof(Line, tags),
     TK_CONFIG_NULL_OK, &rbcListOption},
    {TK_CONFIG_COLOR, "-color", "color", "Color",
     DEF_LINE_PEN_COLOR, offsetof(Line, builtinPen.traceColor),
     TK_CONFIG_COLOR_ONLY},
    {TK_CONFIG_COLOR, "-color", "color", "Color",
     DEF_LINE_PEN_MONO, offsetof(Line, builtinPen.traceColor),
     TK_CONFIG_MONO_ONLY},
    {TK_CONFIG_CUSTOM, "-dashes", "dashes", "Dashes",
     DEF_LINE_DASHES, offsetof(Line, builtinPen.traceDashes),
    ...
    {TK_CONFIG_CUSTOM, "-errorbarcolor", "errorBarColor", "ErrorBarColor",
     DEF_LINE_ERRORBAR_COLOR, offsetof(Line, builtinPen.errorBarColor),
     0, &rbcColorOption},
    {TK_CONFIG_CUSTOM, "-errorbarwidth", "errorBarWidth", "ErrorBarWidth",
     DEF_LINE_ERRORBAR_LINE_WIDTH,
     offsetof(Line, builtinPen.errorBarLineWidth),
    ...
    {TK_CONFIG_CUSTOM, "-errorbarcap", "errorBarCap", "ErrorBarCap",
     ...
     offsetof(Line, builtinPen.errorBarCapWidth),
     TK_CONFIG_DONT_SET_DEFAULT, &rbcDistanceOption},
    {TK_CONFIG_CUSTOM, "-fill", "fill", "Fill",
     DEF_LINE_FILL_COLOR, offsetof(Line, builtinPen.symbol.fillColor),
     TK_CONFIG_NULL_OK | TK_CONFIG_COLOR_ONLY, &rbcColorOption},
    {TK_CONFIG_CUSTOM, "-fill", "fill", "Fill",
     DEF_LINE_FILL_MONO, offsetof(Line, builtinPen.symbol.fillColor),
     TK_CONFIG_NULL_OK | TK_CONFIG_MONO_ONLY, &rbcColorOption},
    {TK_CONFIG_BOOLEAN, "-hide", "hide", "Hide",
     DEF_LINE_HIDE, offsetof(Line, hidden), TK_CONFIG_DONT_SET_DEFAULT},
    {TK_CONFIG_STRING, "-label", "label", "Label",
     (char *)NULL, offsetof(Line, label), TK_CONFIG_NULL_OK},
    {TK_CONFIG_RELIEF, "-labelrelief", "labelRelief", "LabelRelief",
     DEF_LINE_LABEL_RELIEF, offsetof(Line, labelRelief),
     TK_CONFIG_DONT_SET_DEFAULT},
    {TK_CONFIG_CUSTOM, "-linewidth", "lineWidth", "LineWidth",
     DEF_LINE_PEN_WIDTH, offsetof(Line, builtinPen.traceWidth),
     TK_CONFIG_DONT_SET_DEFAULT, &rbcDistanceOption},
    {TK_CONFIG_CUSTOM, "-mapx", "mapX", "MapX",
     DEF_LINE_AXIS_X, offsetof(Line, axes.x), 0, &rbcXAxisOption},
    {TK_CONFIG_CUSTOM, "-mapy", "mapY", "MapY",
     DEF_LINE_AXIS_Y, offsetof(Line, axes.y), 0, &rbcYAxisOption},
    {TK_CONFIG_CUSTOM, "-maxsymbols", "maxSymbols", "MaxSymbols",
     DEF_LINE_MAX_SYMBOLS, offsetof(Line, reqMaxSymbols),
     TK_CONFIG_DONT_SET_DEFAULT, &rbcDistanceOption},
    {TK_CONFIG_CUSTOM, "-offdash", "offDash", "OffDash",
     DEF_LINE_OFFDASH_COLOR, offsetof(Line, builtinPen.traceOffColor),
     TK_CONFIG_NULL_OK | TK_CONFIG_COLOR_ONLY, &rbcColorOption},
    {TK_CONFIG_CUSTOM, "-offdash", "offDash", "OffDash",
     DEF_LINE_OFFDASH_MONO, offsetof(Line, builtinPen.traceOffColor),
     TK_CONFIG_NULL_OK | TK_CONFIG_MONO_ONLY, &rbcColorOption},
    {TK_CONFIG_CUSTOM, "-outline", "outline", "Outline",
     DEF_LINE_OUTLINE_COLOR, offsetof(Line, builtinPen.symbol.outlineColor),
     TK_CONFIG_COLOR_ONLY, &rbcColorOption},
    {TK_CONFIG_CUSTOM, "-outline", "outline", "Outline",
     DEF_LINE_OUTLINE_MONO, offsetof(Line, builtinPen.symbol.outlineColor),
     TK_CONFIG_MONO_ONLY, &rbcColorOption},
    {TK_CONFIG_CUSTOM, "-outlinewidth", "outlineWidth", "OutlineWidth",
     DEF_LINE_OUTLINE_WIDTH, offsetof(Line, builtinPen.symbol.outlineWidth),
     TK_CONFIG_DONT_SET_DEFAULT, &rbcDistanceOption},
    {TK_CONFIG_CUSTOM, "-pen", "pen", "Pen",
     (char *)NULL, offsetof(Line, normalPenPtr),
     TK_CONFIG_NULL_OK, &rbcLinePenOption},
    {TK_CONFIG_CUSTOM, "-pixels", "pixels", "Pixels",
     DEF_LINE_PIXELS, offsetof(Line, builtinPen.symbol.size),
     GRAPH | STRIPCHART, &rbcDistanceOption},
    {TK_CONFIG_DOUBLE, "-reduce", "reduce", "Reduce",
     DEF_LINE_REDUCE, offsetof(Line, rTolerance),
     GRAPH | STRIPCHART | TK_CONFIG_DONT_SET_DEFAULT},
    {TK_CONFIG_BOOLEAN, "-scalesymbols", "scaleSymbols", "ScaleSymbols",
     DEF_LINE_SCALE_SYMBOLS, offsetof(Line, scaleSymbols),
     TK_CONFIG_DONT_SET_DEFAULT},
    {TK_CONFIG_CUSTOM, "-showerrorbars", "showErrorBars", "ShowErrorBars",
     DEF_LINE_SHOW_ERRORBARS, offsetof(Line, builtinPen.errorBarShow),
     TK_CONFIG_DONT_SET_DEFAULT, &rbcFillOption},
    {TK_CONFIG_CUSTOM, "-showvalues", "showValues", "ShowValues",
     DEF_PEN_SHOW_VALUES, offsetof(Line, builtinPen.valueShow),
     TK_CONFIG_DONT_SET_DEFAULT, &rbcFillOption},
    {TK_CONFIG_CUSTOM, "-smooth", "smooth", "Smooth",
     DEF_LINE_SMOOTH, offsetof(Line, reqSmooth),
     TK_CONFIG_DONT_SET_DEFAULT, &smoothOption},
    {TK_CONFIG_CUSTOM, "-state", "state", "State",
     DEF_LINE_STATE, offsetof(Line, state),
     TK_CONFIG_DONT_SET_DEFAULT, &rbcStateOption},
    {TK_CONFIG_CUSTOM, "-styles", "styles", "Styles",
     DEF_LINE_STYLES, offsetof(Line, palette),
     TK_CONFIG_NULL_OK, &stylesOption},
    {TK_CONFIG_CUSTOM, "-symbol", "symbol", "Symbol",
     DEF_LINE_SYMBOL, offsetof(Line, builtinPen.symbol),
     TK_CONFIG_DONT_SET_DEFAULT, &symbolOption},
    {TK_CONFIG_CUSTOM, "-trace", "trace", "Trace",
     DEF_LINE_PEN_DIRECTION, offsetof(Line, penDir),
    ...
    {TK_CONFIG_COLOR, "-valuecolor", "valueColor", "ValueColor",
     DEF_PEN_VALUE_COLOR, offsetof(Line, builtinPen.valueStyle.color), 0},
    {TK_CONFIG_FONT, "-valuefont", "valueFont", "ValueFont",
     DEF_PEN_VALUE_FONT, offsetof(Line, builtinPen.valueStyle.font), 0},
    {TK_CONFIG_STRING, "-valueformat", "valueFormat", "ValueFormat",
     DEF_PEN_VALUE_FORMAT, offsetof(Line, builtinPen.valueFormat),
     TK_CONFIG_NULL_OK},
    {TK_CONFIG_DOUBLE, "-valuerotate", "valueRotate", "ValueRotate",
     DEF_PEN_VALUE_ROTATE, offsetof(Line, builtinPen.valueStyle.theta), 0},
    {TK_CONFIG_CUSTOM, "-valueshadow", "valueShadow", "ValueShadow",
     DEF_PEN_VALUE_SHADOW, offsetof(Line, builtinPen.valueStyle.shadow),
     0, &rbcShadowOption},
    {TK_CONFIG_CUSTOM, "-weights", "weights", "Weights",
     (char *)NULL, offsetof(Line, w), 0, &rbcDataOption},
    {TK_CONFIG_CUSTOM, "-x", "xData", "XData",
     (char *)NULL, offsetof(Line, x), 0, &rbcDataOption},
    {TK_CONFIG_CUSTOM, "-xdata", "xData", "XData",
     (char *)NULL, offsetof(Line, x), 0, &rbcDataOption},
    {TK_CONFIG_CUSTOM, "-xerror", "xError", "XError",
     (char *)NULL, offsetof(Line, xError), 0, &rbcDataOption},
    {TK_CONFIG_CUSTOM, "-xhigh", "xHigh", "XHigh",
     (char *)NULL, offsetof(Line, xHigh), 0, &rbcDataOption},
    {TK_CONFIG_CUSTOM, "-xlow", "xLow", "XLow",
     (char *)NULL, offsetof(Line, xLow), 0, &rbcDataOption},
    {TK_CONFIG_CUSTOM, "-y", "yData", "YData",
     (char *)NULL, offsetof(Line, y), 0, &rbcDataOption},
    {TK_CONFIG_CUSTOM, "-ydata", "yData", "YData",
     (char *)NULL, offsetof(Line, y), 0, &rbcDataOption},
    {TK_CONFIG_CUSTOM, "-yerror", "yError", "YError",
     (char *)NULL, offsetof(Line, yError), 0, &rbcDataOption},
    {TK_CONFIG_CUSTOM, "-yhigh", "yHigh", "YHigh",
     (char *)NULL, offsetof(Line, yHigh), 0, &rbcDataOption},
    {TK_CONFIG_CUSTOM, "-ylow", "yLow", "YLow",
     (char *)NULL, offsetof(Line, yLow), 0, &rbcDataOption},
...
static Tk_ConfigSpec stripElemConfigSpecs[] = {
    {TK_CONFIG_CUSTOM, "-activepen", "activePen", "ActivePen",
        DEF_LINE_ACTIVE_PEN, offsetof(Line, activePenPtr),
        TK_CONFIG_NULL_OK, &rbcLinePenOption},
    {TK_CONFIG_CUSTOM, "-bindtags", "bindTags", "BindTags",
     DEF_LINE_TAGS, offsetof(Line, tags),
     TK_CONFIG_NULL_OK, &rbcListOption},
    ...
    {TK_CONFIG_CUSTOM, "-pen", "pen", "Pen",
     ...
     TK_CONFIG_NULL_OK, &rbcLinePenOption},
    {TK_CONFIG_CUSTOM, "-pixels", "pixels", "Pixels",
     DEF_LINE_PIXELS, offsetof(Line, builtinPen.symbol.size), 0,
     &rbcDistanceOption},
    {TK_CONFIG_BOOLEAN, "-scalesymbols", "scaleSymbols", "ScaleSymbols",
     DEF_LINE_SCALE_SYMBOLS, offsetof(Line, scaleSymbols),
     TK_CONFIG_DONT_SET_DEFAULT},
    ...
    {TK_CONFIG_DOUBLE, "-valuerotate", "valueRotate", "ValueRotate",
     DEF_PEN_VALUE_ROTATE, offsetof(Line, builtinPen.valueStyle.theta), 0},
    {TK_CONFIG_CUSTOM, "-valueshadow", "valueShadow", "ValueShadow",
     DEF_PEN_VALUE_SHADOW, offsetof(Line, builtinPen.valueStyle.shadow), 0,
     &rbcShadowOption},
    {TK_CONFIG_CUSTOM, "-weights", "weights", "Weights",
     (char *)NULL, offsetof(Line, w), 0, &rbcDataOption},
    {TK_CONFIG_CUSTOM, "-x", "xData", "XData",
    ...
    {TK_CONFIG_CUSTOM, "-xerror", "xError", "XError", (char *)NULL,
     offsetof(Line, xError), 0, &rbcDataOption},
    {TK_CONFIG_CUSTOM, "-ydata", "yData", "YData",
     (char *)NULL, offsetof(Line, y), 0, &rbcDataOption},
    {TK_CONFIG_CUSTOM, "-yerror", "yError", "YError", (char *)NULL,
     offsetof(Line, yError), 0, &rbcDataOption},
    {TK_CONFIG_CUSTOM, "-xhigh", "xHigh", "XHigh", (char *)NULL,
     offsetof(Line, xHigh), 0, &rbcDataOption},
    {TK_CONFIG_CUSTOM, "-xlow", "xLow", "XLow", (char *)NULL,
     offsetof(Line, xLow), 0, &rbcDataOption},
    {TK_CONFIG_CUSTOM, "-yhigh", "yHigh", "YHigh", (char *)NULL,
     offsetof(Line, xHigh), 0, &rbcDataOption},
    {TK_CONFIG_CUSTOM, "-ylow", "yLow", "YLow", (char *)NULL,
     offsetof(Line, yLow), 0, &rbcDataOption},
    {TK_CONFIG_END, NULL, NULL, NULL, NULL, 0, 0}
};

static Tk_ConfigSpec linePenConfigSpecs[] = {
    {TK_CONFIG_COLOR, "-color", "color", "Color",
        DEF_PEN_ACTIVE_COLOR, offsetof(LinePen, traceColor),
        TK_CONFIG_COLOR_ONLY | ACTIVE_PEN},
    {TK_CONFIG_COLOR, "-color", "color", "Color",
     DEF_PEN_ACTIVE_MONO, offsetof(LinePen, traceColor),
     TK_CONFIG_MONO_ONLY | ACTIVE_PEN},
    {TK_CONFIG_COLOR, "-color", "color", "Color",
     DEF_PEN_NORMAL_COLOR, offsetof(LinePen, traceColor),
     TK_CONFIG_COLOR_ONLY | NORMAL_PEN},
    {TK_CONFIG_COLOR, "-color", "color", "Color",
     DEF_PEN_NORMAL_MONO, offsetof(LinePen, traceColor),
     TK_CONFIG_MONO_ONLY | NORMAL_PEN},
    {TK_CONFIG_CUSTOM, "-dashes", "dashes", "Dashes",
     DEF_PEN_DASHES, offsetof(LinePen, traceDashes),
     TK_CONFIG_NULL_OK | ALL_PENS, &rbcDashesOption},
    {TK_CONFIG_CUSTOM, "-errorbarcolor", "errorBarColor", "ErrorBarColor",
     DEF_LINE_ERRORBAR_COLOR, offsetof(LinePen, errorBarColor),
     ALL_PENS, &rbcColorOption},
    {TK_CONFIG_CUSTOM, "-errorbarwidth", "errorBarWidth", "ErrorBarWidth",
     DEF_LINE_ERRORBAR_LINE_WIDTH, offsetof(LinePen, errorBarLineWidth),
     ALL_PENS | TK_CONFIG_DONT_SET_DEFAULT, &rbcDistanceOption},
    {TK_CONFIG_CUSTOM, "-errorbarcap", "errorBarCap",
     "ErrorBarCap", DEF_LINE_ERRORBAR_CAP_WIDTH,
     offsetof(LinePen, errorBarCapWidth),
     TK_CONFIG_DONT_SET_DEFAULT, &rbcDistanceOption},
    {TK_CONFIG_CUSTOM, "-fill", "fill", "Fill",
     DEF_PEN_FILL_COLOR, offsetof(LinePen, symbol.fillColor),
     TK_CONFIG_NULL_OK | TK_CONFIG_COLOR_ONLY | ALL_PENS, &rbcColorOption},
    {TK_CONFIG_CUSTOM, "-fill", "fill", "Fill",
     DEF_PEN_FILL_MONO, offsetof(LinePen, symbol.fillColor),
     TK_CONFIG_NULL_OK | TK_CONFIG_MONO_ONLY | ALL_PENS, &rbcColorOption},
    {TK_CONFIG_CUSTOM, "-linewidth", "lineWidth", "LineWidth",
     (char *)NULL, offsetof(LinePen, traceWidth),
     ALL_PENS | TK_CONFIG_DONT_SET_DEFAULT, &rbcDistanceOption},
    {TK_CONFIG_CUSTOM, "-offdash", "offDash", "OffDash",
     DEF_PEN_OFFDASH_COLOR, offsetof(LinePen, traceOffColor),
     TK_CONFIG_NULL_OK | TK_CONFIG_COLOR_ONLY | ALL_PENS, &rbcColorOption},
    {TK_CONFIG_CUSTOM, "-offdash", "offDash", "OffDash",
     DEF_PEN_OFFDASH_MONO, offsetof(LinePen, traceOffColor),
     TK_CONFIG_NULL_OK | TK_CONFIG_MONO_ONLY | ALL_PENS, &rbcColorOption},
    {TK_CONFIG_CUSTOM, "-outline", "outline", "Outline",
     DEF_PEN_OUTLINE_COLOR, offsetof(LinePen, symbol.outlineColor),
     TK_CONFIG_COLOR_ONLY | ALL_PENS, &rbcColorOption},
    {TK_CONFIG_CUSTOM, "-outline", "outline", "Outline",
     DEF_PEN_OUTLINE_MONO, offsetof(LinePen, symbol.outlineColor),
     TK_CONFIG_MONO_ONLY | ALL_PENS, &rbcColorOption},
    {TK_CONFIG_CUSTOM, "-outlinewidth", "outlineWidth", "OutlineWidth",
     DEF_PEN_OUTLINE_WIDTH, offsetof(LinePen, symbol.outlineWidth),
     TK_CONFIG_DONT_SET_DEFAULT | ALL_PENS, &rbcDistanceOption},
    {TK_CONFIG_CUSTOM, "-pixels", "pixels", "Pixels",
     DEF_PEN_PIXELS, offsetof(LinePen, symbol.size),
     ALL_PENS, &rbcDistanceOption},
    {TK_CONFIG_CUSTOM, "-showerrorbars", "showErrorBars", "ShowErrorBars",
     DEF_LINE_SHOW_ERRORBARS, offsetof(LinePen, errorBarShow),
     TK_CONFIG_DONT_SET_DEFAULT, &rbcFillOption},
    {TK_CONFIG_CUSTOM, "-showvalues", "showValues", "ShowValues",
     DEF_PEN_SHOW_VALUES, offsetof(LinePen, valueShow),
     ALL_PENS | TK_CONFIG_DONT_SET_DEFAULT, &rbcFillOption},
    {TK_CONFIG_CUSTOM, "-symbol", "symbol", "Symbol",
     DEF_PEN_SYMBOL, offsetof(LinePen, symbol),
     TK_CONFIG_DONT_SET_DEFAULT | ALL_PENS, &symbolOption},
    {TK_CONFIG_STRING, "-type", (char *)NULL, (char *)NULL,
     DEF_PEN_TYPE, offsetof(Pen, typeId), ALL_PENS | TK_CONFIG_NULL_OK},
    {TK_CONFIG_ANCHOR, "-valueanchor", "valueAnchor", "ValueAnchor",
     DEF_PEN_VALUE_ANCHOR, offsetof(LinePen, valueStyle.anchor), ALL_PENS},
    {TK_CONFIG_COLOR, "-valuecolor", "valueColor", "ValueColor",
     DEF_PEN_VALUE_COLOR, offsetof(LinePen, valueStyle.color), ALL_PENS},
    {TK_CONFIG_FONT, "-valuefont", "valueFont", "ValueFont",
     DEF_PEN_VALUE_FONT, offsetof(LinePen, valueStyle.font), ALL_PENS},
    {TK_CONFIG_STRING, "-valueformat", "valueFormat", "ValueFormat",
     DEF_PEN_VALUE_FORMAT, offsetof(LinePen, valueFormat),
     ALL_PENS | TK_CONFIG_NULL_OK},
    {TK_CONFIG_DOUBLE, "-valuerotate", "valueRotate", "ValueRotate",
     DEF_PEN_VALUE_ROTATE, offsetof(LinePen, valueStyle.theta), ALL_PENS},
    {TK_CONFIG_CUSTOM, "-valueshadow", "valueShadow", "ValueShadow",
     DEF_PEN_VALUE_SHADOW, offsetof(LinePen, valueStyle.shadow),
