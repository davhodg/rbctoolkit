...
static Tk_ConfigSpec configSpecs[] = {
    {TK_CONFIG_DOUBLE, "-autorange", "autoRange", "AutoRange", DEF_AXIS_RANGE, Tk_Offset(Axis, windowSize), ALL_GRAPHS | TK_CONFIG_DONT_SET_DEFAULT},
    {TK_CONFIG_BORDER, "-background", "background", "Background", DEF_AXIS_BACKGROUND, Tk_Offset(Axis, border), ALL_GRAPHS | TK_CONFIG_NULL_OK},
    {TK_CONFIG_SYNONYM, "-bg", "background", (char *)NULL, (char *)NULL, 0, 0},
    {TK_CONFIG_CUSTOM, "-bindtags", "bindTags", "BindTags", DEF_AXIS_TAGS, Tk_Offset(Axis, tags), ALL_GRAPHS | TK_CONFIG_NULL_OK, &rbcListOption},
    {TK_CONFIG_SYNONYM, "-bd", "borderWidth", (char *)NULL, (char *)NULL, 0, ALL_GRAPHS},
    {TK_CONFIG_CUSTOM, "-borderwidth", "borderWidth", "BorderWidth", DEF_AXIS_BORDERWIDTH, Tk_Offset(Axis, borderWidth), ALL_GRAPHS | TK_CONFIG_DONT_SET_DEFAULT, &rbcDistanceOption},
    {TK_CONFIG_COLOR, "-color", "color", "Color", DEF_AXIS_FOREGROUND, Tk_Offset(Axis, tickTextStyle.color), TK_CONFIG_COLOR_ONLY | ALL_GRAPHS},
    {TK_CONFIG_COLOR, "-color", "color", "Color", DEF_AXIS_FG_MONO, Tk_Offset(Axis, tickTextStyle.color), TK_CONFIG_MONO_ONLY | ALL_GRAPHS},
    {TK_CONFIG_STRING, "-command", "command", "Command", DEF_AXIS_COMMAND, Tk_Offset(Axis, formatCmd), TK_CONFIG_NULL_OK | ALL_GRAPHS},
    {TK_CONFIG_BOOLEAN, "-descending", "descending", "Descending", DEF_AXIS_DESCENDING, Tk_Offset(Axis, descending), ALL_GRAPHS | TK_CONFIG_DONT_SET_DEFAULT},
    {TK_CONFIG_BOOLEAN, "-hide", "hide", "Hide", DEF_AXIS_HIDE, Tk_Offset(Axis, hidden), ALL_GRAPHS | TK_CONFIG_DONT_SET_DEFAULT},
    {TK_CONFIG_JUSTIFY, "-justify", "justify", "Justify", DEF_AXIS_JUSTIFY, Tk_Offset(Axis, titleTextStyle.justify), ALL_GRAPHS | TK_CONFIG_DONT_SET_DEFAULT},
    {TK_CONFIG_BOOLEAN, "-labeloffset", "labelOffset", "LabelOffset", (char *)NULL, Tk_Offset(Axis, labelOffset), ALL_GRAPHS},
    {TK_CONFIG_COLOR, "-limitscolor", "limitsColor", "Color", DEF_AXIS_FOREGROUND, Tk_Offset(Axis, limitsTextStyle.color), TK_CONFIG_COLOR_ONLY | ALL_GRAPHS},
    {TK_CONFIG_COLOR, "-limitscolor", "limitsColor", "Color", DEF_AXIS_FG_MONO, Tk_Offset(Axis, limitsTextStyle.color), TK_CONFIG_MONO_ONLY | ALL_GRAPHS},
    {TK_CONFIG_FONT, "-limitsfont", "limitsFont", "Font", DEF_AXIS_TICK_FONT, Tk_Offset(Axis, limitsTextStyle.font), ALL_GRAPHS},
    {TK_CONFIG_CUSTOM, "-limitsformat", "limitsFormat", "LimitsFormat", (char *)NULL, Tk_Offset(Axis, limitsFormats), TK_CONFIG_NULL_OK | ALL_GRAPHS, &formatOption},
    {TK_CONFIG_CUSTOM, "-limitsshadow", "limitsShadow", "Shadow", (char *)NULL, Tk_Offset(Axis, limitsTextStyle.shadow), TK_CONFIG_COLOR_ONLY | ALL_GRAPHS, &rbcShadowOption},
    {TK_CONFIG_CUSTOM, "-limitsshadow", "limitsShadow", "Shadow", (char *)NULL, Tk_Offset(Axis, limitsTextStyle.shadow), TK_CONFIG_MONO_ONLY | ALL_GRAPHS, &rbcShadowOption},
    {TK_CONFIG_CUSTOM, "-linewidth", "lineWidth", "LineWidth", DEF_AXIS_LINE_WIDTH, Tk_Offset(Axis, lineWidth), ALL_GRAPHS | TK_CONFIG_DONT_SET_DEFAULT, &rbcDistanceOption},
    {TK_CONFIG_BOOLEAN, "-logscale", "logScale", "LogScale", DEF_AXIS_LOGSCALE, Tk_Offset(Axis, logScale), ALL_GRAPHS | TK_CONFIG_DONT_SET_DEFAULT},
    {TK_CONFIG_CUSTOM, "-loose", "loose", "Loose", DEF_AXIS_LOOSE, 0, ALL_GRAPHS | TK_CONFIG_DONT_SET_DEFAULT, &looseOption},
    {TK_CONFIG_CUSTOM, "-majorticks", "majorTicks", "MajorTicks", (char *)NULL, Tk_Offset(Axis, t1Ptr), TK_CONFIG_NULL_OK | ALL_GRAPHS, &majorTicksOption},
    {TK_CONFIG_CUSTOM, "-max", "max", "Max", (char *)NULL, Tk_Offset(Axis, reqMax), TK_CONFIG_NULL_OK | ALL_GRAPHS, &limitOption},
    {TK_CONFIG_CUSTOM, "-min", "min", "Min", (char *)NULL, Tk_Offset(Axis, reqMin), TK_CONFIG_NULL_OK | ALL_GRAPHS, &limitOption},
    {TK_CONFIG_CUSTOM, "-minorticks", "minorTicks", "MinorTicks", (char *)NULL, Tk_Offset(Axis, t2Ptr), TK_CONFIG_NULL_OK | ALL_GRAPHS, &minorTicksOption},
    {TK_CONFIG_RELIEF, "-relief", "relief", "Relief", DEF_AXIS_RELIEF, Tk_Offset(Axis, relief), ALL_GRAPHS | TK_CONFIG_DONT_SET_DEFAULT},
    {TK_CONFIG_DOUBLE, "-rotate", "rotate", "Rotate", DEF_AXIS_ROTATE, Tk_Offset(Axis, tickTextStyle.theta), ALL_GRAPHS | TK_CONFIG_DONT_SET_DEFAULT},
    {TK_CONFIG_STRING, "-scrollcommand", "scrollCommand", "ScrollCommand", (char *)NULL, Tk_Offset(Axis, scrollCmdPrefix), ALL_GRAPHS | TK_CONFIG_NULL_OK},
    {TK_CONFIG_CUSTOM, "-scrollincrement", "scrollIncrement", "ScrollIncrement", DEF_AXIS_SCROLL_INCREMENT, Tk_Offset(Axis, scrollUnits), ALL_GRAPHS | TK_CONFIG_DONT_SET_DEFAULT, &rbcPositiveDistanceOption},
    {TK_CONFIG_CUSTOM, "-scrollmax", "scrollMax", "ScrollMax", (char *)NULL, Tk_Offset(Axis, scrollMax), TK_CONFIG_NULL_OK | ALL_GRAPHS, &limitOption},
    {TK_CONFIG_CUSTOM, "-scrollmin", "scrollMin", "ScrollMin", (char *)NULL, Tk_Offset(Axis, scrollMin), TK_CONFIG_NULL_OK | ALL_GRAPHS, &limitOption},
    {TK_CONFIG_DOUBLE, "-shiftby", "shiftBy", "ShiftBy", DEF_AXIS_SHIFTBY, Tk_Offset(Axis, shiftBy), ALL_GRAPHS | TK_CONFIG_DONT_SET_DEFAULT},
    {TK_CONFIG_BOOLEAN, "-showticks", "showTicks", "ShowTicks", DEF_AXIS_SHOWTICKS, Tk_Offset(Axis, showTicks), ALL_GRAPHS | TK_CONFIG_DONT_SET_DEFAULT},
    {TK_CONFIG_DOUBLE, "-stepsize", "stepSize", "StepSize", DEF_AXIS_STEP, Tk_Offset(Axis, reqStep), ALL_GRAPHS | TK_CONFIG_DONT_SET_DEFAULT},
    {TK_CONFIG_DOUBLE, "-tickdivider", "tickDivider", "TickDivider", DEF_AXIS_STEP, Tk_Offset(Axis, tickZoom), ALL_GRAPHS | TK_CONFIG_DONT_SET_DEFAULT},
    {TK_CONFIG_INT, "-subdivisions", "subdivisions", "Subdivisions", DEF_AXIS_SUBDIVISIONS, Tk_Offset(Axis, reqNumMinorTicks), ALL_GRAPHS},
    {TK_CONFIG_FONT, "-tickfont", "tickFont", "Font", DEF_AXIS_TICK_FONT, Tk_Offset(Axis, tickTextStyle.font), ALL_GRAPHS},
    {TK_CONFIG_PIXELS, "-ticklength", "tickLength", "TickLength", DEF_AXIS_TICK_LENGTH, Tk_Offset(Axis, tickLength), ALL_GRAPHS},
    {TK_CONFIG_CUSTOM, "-tickshadow", "tickShadow", "Shadow", (char *)NULL, Tk_Offset(Axis, tickTextStyle.shadow), TK_CONFIG_COLOR_ONLY | ALL_GRAPHS, &rbcShadowOption},
    {TK_CONFIG_CUSTOM, "-tickshadow", "tickShadow", "Shadow", (char *)NULL, Tk_Offset(Axis, tickTextStyle.shadow), TK_CONFIG_MONO_ONLY | ALL_GRAPHS, &rbcShadowOption},
    {TK_CONFIG_STRING, "-title", "title", "Title", (char *)NULL, Tk_Offset(Axis, title), TK_CONFIG_DONT_SET_DEFAULT | TK_CONFIG_NULL_OK | ALL_GRAPHS},
    {TK_CONFIG_BOOLEAN, "-titlealternate", "titleAlternate", "TitleAlternate", DEF_AXIS_TITLE_ALTERNATE, Tk_Offset(Axis, titleAlternate), TK_CONFIG_DONT_SET_DEFAULT | ALL_GRAPHS},
    {TK_CONFIG_COLOR, "-titlecolor", "titleColor", "Color", DEF_AXIS_FOREGROUND, Tk_Offset(Axis, titleTextStyle.color), TK_CONFIG_COLOR_ONLY | ALL_GRAPHS},
    {TK_CONFIG_COLOR, "-titlecolor", "titleColor", "TitleColor", DEF_AXIS_FG_MONO, Tk_Offset(Axis, titleTextStyle.color), TK_CONFIG_MONO_ONLY | ALL_GRAPHS},
    {TK_CONFIG_FONT, "-titlefont", "titleFont", "Font", DEF_AXIS_TITLE_FONT, Tk_Offset(Axis, titleTextStyle.font), ALL_GRAPHS},
    {TK_CONFIG_CUSTOM, "-titleshadow", "titleShadow", "Shadow", (char *)NULL, Tk_Offset(Axis, titleTextStyle.shadow), TK_CONFIG_COLOR_ONLY | ALL_GRAPHS, &rbcShadowOption},
    {TK_CONFIG_CUSTOM, "-titleshadow", "titleShadow", "Shadow", (char *)NULL, Tk_Offset(Axis, titleTextStyle.shadow), TK_CONFIG_MONO_ONLY | ALL_GRAPHS, &rbcShadowOption},
...
static int NameToAxis (Graph *graphPtr, char *name, Axis **axisPtrPtr);
    ...
    Axis *axisPtr;
{
    ...
    if (axisPtr->title != NULL) {
        Rbc_DrawText(graphPtr->tkwin, drawable, axisPtr->title,
    ...
    if (axisPtr->scrollCmdPrefix != NULL) {
        ...
        if (isHoriz != axisPtr->descending) {
            ...
            Rbc_UpdateScrollbar(graphPtr->interp, axisPtr->scrollCmdPrefix,
    ...
    if (axisPtr->showTicks) {
        ...
        for (linkPtr = Rbc_ChainFirstLink(axisPtr->tickLabels); linkPtr != NULL;
            ...
            labelPtr = Rbc_ChainGetValue(linkPtr);
            Rbc_DrawText(graphPtr->tkwin, drawable, labelPtr->string,
    ...
    if ((axisPtr->nSegments > 0) && (axisPtr->lineWidth > 0)) {
        ...
        Rbc_Draw2DSegments(graphPtr->display, drawable, axisPtr->tickGC,
    ...
    Axis *axisPtr;
{
    ...
    if (axisPtr->showTicks) {
        ...
        for (linkPtr = Rbc_ChainFirstLink(axisPtr->tickLabels);
                linkPtr != NULL; linkPtr = Rbc_ChainNextLink(linkPtr)) {
            labelPtr = Rbc_ChainGetValue(linkPtr);
            Rbc_TextToPostScript(psToken, labelPtr->string,
                                 &axisPtr->tickTextStyle, labelPtr->anchorPos.x,
                                 labelPtr->anchorPos.y);
        }
    }
    if ((axisPtr->nSegments > 0) && (axisPtr->lineWidth > 0)) {
        Rbc_LineAttributesToPostScript(psToken, axisPtr->tickTextStyle.color,
                                       axisPtr->lineWidth, (Rbc_Dashes *)NULL, CapButt, JoinMiter);
        Rbc_2DSegmentsToPostScript(psToken, axisPtr->segments,
                                   axisPtr->nSegments);
    }
}
    ...
    Axis *axisPtr;
{
    ...
    if (axisPtr->showTicks) {
        ...
        for (i = 0; i < axisPtr->t1Ptr->nTicks; i++) {
             ...
             */
            Rbc_GetTextExtents(&axisPtr->tickTextStyle, labelPtr->string,
                               &lw, &lh);
            labelPtr->width = lw;
            labelPtr->height = lh;
            ...
            if (axisPtr->tickTextStyle.theta > 0.0) {
                ...
                Rbc_GetBoundingBox(lw, lh, axisPtr->tickTextStyle.theta,
    ...
    Margin *marginPtr;
{
    ...
    for (linkPtr = Rbc_ChainFirstLink(marginPtr->axes); linkPtr != NULL;
            linkPtr = Rbc_ChainNextLink(linkPtr)) {
    ...
    char **argv; /* Not used. */
{
    ...
    Tcl_AppendElement(interp, Rbc_Dtoa(interp, min));
    Tcl_AppendElement(interp, Rbc_Dtoa(interp, max));
    return TCL_OK;
}
    ...
    char **argv;
{
    ...
    Tcl_AppendElement(graphPtr->interp, Rbc_Dtoa(graphPtr->interp, y));
    return TCL_OK;
}
    ...
    char **argv;
{
    ...
    Tcl_SetResult(graphPtr->interp, Rbc_Itoa((int)x), TCL_VOLATILE);
    return TCL_OK;
}
    ...
    Drawable drawable;
{
    ...
    for (i = 0; i < 4; i++) {
        for (linkPtr = Rbc_ChainFirstLink(graphPtr->margins[i].axes);
                linkPtr != NULL; linkPtr = Rbc_ChainNextLink(linkPtr)) {
            axisPtr = Rbc_ChainGetValue(linkPtr);
            if ((!axisPtr->hidden) && (axisPtr->flags & AXIS_ONSCREEN)) {
                DrawAxis(graphPtr, drawable, axisPtr);
    ...
    for (hPtr = Tcl_FirstHashEntry(&graphPtr->axes.table, &cursor);
        ...
        if (maxPtr != NULL) {
            if (isHoriz) {
                ...
                Rbc_DrawText2(graphPtr->tkwin, drawable, maxPtr,
        ...
        if (minPtr != NULL) {
            ...
            if (isHoriz) {
                axisPtr->limitsTextStyle.theta = 90.0;
                Rbc_DrawText2(graphPtr->tkwin, drawable, minPtr,
...
#define SPACING 8
    ...
    for (hPtr = Tcl_FirstHashEntry(&graphPtr->axes.table, &cursor);
        ...
        if (*maxFmt != '\0') {
            ...
            Rbc_GetTextExtents(&axisPtr->tickTextStyle, string, &textWidth,
                               &textHeight);
            if ((textWidth > 0) && (textHeight > 0)) {
                if (axisPtr->classUid == rbcXAxisUid) {
                    axisPtr->limitsTextStyle.theta = 90.0;
                    axisPtr->limitsTextStyle.anchor = TK_ANCHOR_SE;
                    Rbc_TextToPostScript(psToken, string,
    ...
    for (hPtr = Tcl_FirstHashEntry(&graphPtr->axes.table, &cursor);
        ...
        if (axisPtr->showTicks) {
            ...
            for (linkPtr = Rbc_ChainFirstLink(axisPtr->tickLabels);
                    linkPtr != NULL; linkPtr = Rbc_ChainNextLink(linkPtr)) {
                labelPtr = Rbc_ChainGetValue(linkPtr);
                Rbc_GetBoundingBox(labelPtr->width, labelPtr->height,
        ...
        if (axisPtr->title != NULL) { /* and then the title string. */
            ...
            Rbc_GetTextExtents(&axisPtr->titleTextStyle, axisPtr->title,&width,
                               &height);
            Rbc_GetBoundingBox(width, height, axisPtr->titleTextStyle.theta,
